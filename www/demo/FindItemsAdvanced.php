...
if(isset($_POST['Query']))
{
  ...
  foreach ($rangeArr as $range)
  {
    ...
    if ($resp && $resp->paginationOutput->totalEntries > 0) {
      ...
      $results .= "<thead><tr><th /><th>Title</th><th>Price &nbsp; &nbsp; </th><th>Location</th><th>Shipping &nbsp; &nbsp; </th><th>Total &nbsp; &nbsp; </th><th><!--Currency--></th><th>Time Left</th><th>End Time</th></tr></thead>\n";
      ...
      foreach($resp->searchResult->item as $item) {
        ...
        $results .= "<tr><td><a href=\"$link\"><img src=\"$picURL\"></a></td><td><a href=\"$link\">$title</a></td>"
             .  "<td>$price</td><td>$postcode $location</td><td>$ship</td><td>$total</td><td>$curr</td><td>$timeLeft</td><td><nobr>$endTime</nobr></td></tr>";
      }
      $results .= "</table>";
    }
